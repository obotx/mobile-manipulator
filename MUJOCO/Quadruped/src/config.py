...
class TeleopConfig:
    ...
    arm_motors_max_vel: Dict[str, float] = field(default_factory=lambda: {
        ...
        "primary_column_lift":    7.5,
        "secondary_column_lift":  7.5,
        "telescopic_extend":      7.5,
        "wrist_pitch":            np.pi,
    ...
    hand_target_mode: str = "wrist" # or "palm"
    jitter_deadband: float = 0.01

    face_target_enabled: bool = True
    yaw_offset: float = 0.0
    anchor_height: float = 1.2
