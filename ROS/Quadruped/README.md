...
Octomap generated by using [gazebo_map_creator](https://github.com/arshadlab/gazebo_map_creator/tree/master) in **ROS2 Humble + Gazebo Classic** different workspace. Then, we add those Octomap to MoveIt planning scene, you can check [here](src/mm_mapping/src/moveit_octomap_handler.py).  
