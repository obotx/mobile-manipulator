...
def generate_launch_description():
    ...
    controller_config = PathJoinSubstitution([pkg_ctrl, 'config', 'controller_manager', 'obotx_dual_arm_controllers.yaml'])
    rqt_config = PathJoinSubstitution([pkg_ctrl, 'config', 'rqt', 'obotx.perspective'])
    rviz_config = PathJoinSubstitution([pkg_desc, 'config', 'rviz', 'obotx.rviz'])
    bridge_config = PathJoinSubstitution([pkg_desc, 'config', 'bridge','ros_gz_bridge.yaml'])
